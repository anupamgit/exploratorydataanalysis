## N.B.: The purpose of Question 6 is to compare the data.
## So, the data has been scaled for a realistic comparison
## Also, it has been drawn on the same graph to ease comparison
## Motor vechicle: "a road vehicle powered by an internal combustion engine."
## So, SCC$EI.Sector "Mobile - On-Road..." values are considered
